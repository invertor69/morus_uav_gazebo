/* Produced by CVXGEN, 2017-06-28 13:19:11 -0400.  */
...
void setup_pointers(void) {
  ...
  vars.x_12 = work.x + 140;
  vars.x_13 = work.x + 146;
  vars.x_14 = work.x + 152;
  vars.x_15 = work.x + 158;
  vars.x_16 = work.x + 164;
  vars.x_17 = work.x + 170;
  vars.x_18 = work.x + 176;
  vars.x_19 = work.x + 182;
}
...
void fillrhs_cc(void) {
  ...
  double minval;
  r2 = work.rhs + 188;
  ds_aff = work.lhs_aff + 188;
  dz_aff = work.lhs_aff + 260;
  mu = 0;
  for (i = 0; i < 72; i++)
